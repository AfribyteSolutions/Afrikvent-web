    ...
    <main className="w-full cms-brand-bg min-h-screen">
      ...
      {sectionEnabled("hero") && <section className="w-full h-screen relative">
        <VideoSlider 
          ...
          title={siteSections.hero?.title || "Discover Amazing Events"}
          subtitle={siteSections.hero?.subtitle || siteSections.hero?.body || "Find the perfect event for you - from conferences to concerts, workshops to festivals"}
          interval={4000} 
