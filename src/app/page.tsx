  ...
  return (
    <main className="w-full cms-brand-bg min-h-screen">
      ...
      {showSearchResults ? (
        ...
        <>
          {sectionEnabled("recommended") && <div>{siteSections.recommended?.title && siteSections.recommended.title !== "Recommended Events" && <div className="max-w-7xl mx-auto px-4 pt-10 -mb-10"><h2 className="text-2xl md:text-4xl font-bold">{siteSections.recommended.title}</h2></div>}{recommendedLoading ? (
          ...
          {sectionEnabled("sponsored") && <div>{siteSections.sponsored?.title && siteSections.sponsored.title !== "Sponsored Events" && <div className="max-w-7xl mx-auto px-4 pt-10 -mb-10"><h2 className="text-2xl md:text-4xl font-bold">{siteSections.sponsored.title}</h2></div>}{sponsoredLoading ? (
          ...
          {sectionEnabled("upcoming") && <div>{siteSections.upcoming?.title && siteSections.upcoming.title !== "Upcoming Events" && <div className="max-w-7xl mx-auto px-4 pt-10 -mb-10"><h2 className="text-2xl md:text-4xl font-bold">{siteSections.upcoming.title}</h2></div>}{upcomingLoading ? (
